...
class AttackHyperParams:
    ...
    # Explicit EOT controls. "legacy" keeps the existing stochastic path.
    ...
    def validate_noise(self) -> None:
        ...
        if self.geometry_mode not in {"legacy", "none", "translation", "resize_pad", "scale", "geometric_mixture"}:
